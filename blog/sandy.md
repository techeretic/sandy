...
And it's been **reviewed and hardened**: a full-repo security review closed 7 findings (shipped as private advisories), followed by a dozen more fix PRs. 346 tests, typecheck and build green. Apache-2.0 licensed, with a minimal, auditable dependency set — the binary report containers are hand-rolled on purpose, to keep the install clean.
