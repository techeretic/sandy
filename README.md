...
```
Host tools exposed: `sandy.gather`, `sandy.report`, `sandy.status`, `sandy.model.usage`, `sandy.write`, and `sandy.files.read|list|write|delete|mkdir|rename`.
